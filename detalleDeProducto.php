...
<html>
    ...
    <body>
        ...
        <main>
            ...
            <!-- Nombre y precio -->
            <section class="product-section summary">
                <h1>Zapatillas negras marca sarasa con lalal y par de medias de regalo</h1>
                <h2>$249.99</h2>
            </section>
            <!-- Descripción -->
            <section class="product-section description">
                <p>
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Aspernatur minus ipsum ullam assumenda magnam explicabo blanditiis aliquam quos sunt tempore libero, repellendus accusamus eum. Fugit blanditiis ab similique ea totam?
